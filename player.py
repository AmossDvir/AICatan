...
class Player():
    ...
    def _build_road(self):
        ...
        # if self.__player_resources[Resources.WOOD.value] < 1 or \
        #         self.__player_resources[Resources.BRICK.value] < 1:
        #     raise ValueError("Not Enough Resources")
