...
def resources_diversity_heuristic(session: GameSession, player: Player):
    ...
    # print("--------------------")
    return __num_res * __num_types / 15
...
def main_heuristic(session: GameSession, player: Player):
    ...
    # print('vp = ', vp_heuristic(session, player))
    # print('harbors = ', harbors_heuristic(session, player))
    # print('res in each = ', prefer_resources_in_each_part(session, player))
    # print('roads = ', roads_heuristic(session, player))
    # print('settles = ', settles_heuristic(session, player))
    # print('res diversity = ', resources_diversity_heuristic(session, player))
    return vp_heuristic(session, player) + \
           harbors_heuristic(session, player) + \
           prefer_resources_in_each_part(session, player) + \
           roads_heuristic(session, player) + \
           settles_heuristic(session, player) + \
           resources_diversity_heuristic(session, player)
